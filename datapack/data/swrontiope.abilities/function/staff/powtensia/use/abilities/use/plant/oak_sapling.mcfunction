summon item_display ^ ^1.5 ^1 {item: {id: 'oak_sapling'}, billboard: 'center', Tags: ['swrontiope.projectile', 'oak_sapling']}
execute at @n[type=item_display, tag=swrontiope.projectile, tag=oak_sapling] run tp @n[type=item_display] ~ ~ ~ facing entity @s eyes
